    ...
    int rangeEnd(int var1_1, int var2_2, int var3_3) {
        do {
                ...
                block9 : {
                    block7 : {
                        block5 : {
                            ...
                            if (var3_3 == this.index[this.highValueIndex]) {
                                var1_1 = var2_2;
                            }
                            ** GOTO lbl38
                        }
            ...
            for (var5_5 = var4_4; var5_5 < var6_6; ++var5_5) {
                if (this.index[var5_5] == var3_3) continue;
...
lbl38: // 5 sources:
    ...
    public int serialize(OutputStream outputStream) throws IOException {
        ...
        for (int i = 0; i < this.dataLength; ++i) {
            ((DataOutputStream)outputStream).writeChar(this.index[this.data16 + i]);
        }
        return 0 + n + this.dataLength * 2;
    }
}
