...
implements SelChImpl {
        ...
        synchronized (object) {
            ...
            block11 : {
                ...
                try {
                    ...
                    do {
                        n2 = n;
                        n3 = IOUtil.read(this.fd, byteBuffer, -1L, nd);
                        if (n3 != -3) break;
                        n = n3;
                        n2 = n3;
                    } while (this.isOpen());
     ...
     */
    @Override
    public long read(ByteBuffer[] arrbyteBuffer) throws IOException {
        ...
        synchronized (object) {
            ...
            block15 : {
                ...
                try {
                    ...
                    do {
                        l2 = l;
                        l3 = IOUtil.read(this.fd, arrbyteBuffer, nd);
                        if (l3 != -3L) break;
                        l = l3;
                        l2 = l3;
                    } while (this.isOpen());
    ...
    public long read(ByteBuffer[] arrbyteBuffer, int n, int n2) throws IOException {
        if (n >= 0 && n2 >= 0 && n <= arrbyteBuffer.length - n2) {
            return this.read(Util.subsequence(arrbyteBuffer, n, n2));
        }
