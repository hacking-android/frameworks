...
extends android.hardware.radio.config.V1_1.IRadioConfigResponse {
    ...
    public void getSimSlotsStatusResponse_1_2(RadioResponseInfo var1, ArrayList<SimSlotStatus> var2) throws RemoteException;
    ...
    implements IRadioConfigResponse {
        ...
        public void getModemsConfigResponse(RadioResponseInfo radioResponseInfo, ModemsConfig modemsConfig) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio.config@1.1::IRadioConfigResponse");
        ...
        @Override
        public void getSimSlotsStatusResponse(RadioResponseInfo radioResponseInfo, ArrayList<android.hardware.radio.config.V1_0.SimSlotStatus> arrayList) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio.config@1.0::IRadioConfigResponse");
            radioResponseInfo.writeToParcel(hwParcel);
            android.hardware.radio.config.V1_0.SimSlotStatus.writeVectorToParcel(hwParcel, arrayList);
            radioResponseInfo = new HwParcel();
            try {
        ...
        public void getSimSlotsStatusResponse_1_2(RadioResponseInfo radioResponseInfo, ArrayList<SimSlotStatus> arrayList) throws RemoteException {
            ...
            radioResponseInfo = new HwParcel();
            try {
                this.mRemote.transact(7, hwParcel, (HwParcel)radioResponseInfo, 1);
                hwParcel.releaseTemporaryStorage();
                return;
            }
            finally {
    ...
    implements IRadioConfigResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({-40, -25, 113, 126, -127, -121, -35, 116, 83, -44, 20, 47, -113, 51, 30, 124, 50, 94, 122, 111, -98, -115, 68, -84, 13, 82, -77, -66, 80, 43, -2, -125}, {-76, 46, -77, -69, -43, -25, -75, 25, -30, -125, 98, 52, 12, 34, 5, -86, 117, 53, 109, -26, -77, 15, 79, -48, -98, -62, -22, 120, 79, 37, 10, -80}, {-94, -23, -73, -86, 9, -9, -108, 38, -9, 101, -125, -127, 116, -32, 75, 111, -102, 62, 108, -117, 118, -71, 35, -4, 23, 5, 99, 34, 7, -70, -44, 75}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioConfigResponse.kInterfaceName, "android.hardware.radio.config@1.1::IRadioConfigResponse", "android.hardware.radio.config@1.0::IRadioConfigResponse", "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel object2, int n2) throws RemoteException {
            ...
            block0 : switch (n) {
                ...
                case 7: {
                    ...
                    this.getSimSlotsStatusResponse_1_2((RadioResponseInfo)object2, SimSlotStatus.readVectorFromParcel((HwParcel)object));
                    break;
                }
                case 6: {
                    n = n7;
                    ...
                    object.enforceInterface("android.hardware.radio.config@1.1::IRadioConfigResponse");
                    object2 = new RadioResponseInfo();
                    object2.readFromParcel((HwParcel)object);
                    ModemsConfig modemsConfig = new ModemsConfig();
                    modemsConfig.readFromParcel((HwParcel)object);
                    this.getModemsConfigResponse((RadioResponseInfo)object2, modemsConfig);
                    break;
                }
                case 5: {
                    n = n8;
                ...
                case 3: {
                    ...
                    object2 = new PhoneCapability();
                    ((PhoneCapability)object2).readFromParcel((HwParcel)object);
                    this.getPhoneCapabilityResponse(radioResponseInfo, (PhoneCapability)object2);
                    break;
                }
                case 2: {
                    n = n11;
                ...
                case 1: {
                    ...
                    object2 = new RadioResponseInfo();
                    object2.readFromParcel((HwParcel)object);
                    this.getSimSlotsStatusResponse((RadioResponseInfo)object2, android.hardware.radio.config.V1_0.SimSlotStatus.readVectorFromParcel((HwParcel)object));
                }
            }
        }
