...
extends IBase {
    ...
    public void getSimSlotsStatus(int var1) throws RemoteException;
    ...
    public void setResponseFunctions(IRadioConfigResponse var1, IRadioConfigIndication var2) throws RemoteException;

    public void setSimSlotsMapping(int var1, ArrayList<Integer> var2) throws RemoteException;
    ...
    implements IRadioConfig {
        ...
        public void setSimSlotsMapping(int n, ArrayList<Integer> hwParcel) throws RemoteException {
            HwParcel hwParcel2 = new HwParcel();
            hwParcel2.writeInterfaceToken(IRadioConfig.kInterfaceName);
    ...
    implements IRadioConfig {
        ...
        public final ArrayList<byte[]> getHashChain() {
            ...
            return new ArrayList<byte[]>(Arrays.asList({-121, 56, 84, 105, -49, 68, 9, -16, -13, 59, 1, 80, -114, 122, 71, 124, -9, 31, 42, 17, -28, 102, -35, 126, 58, -75, -105, 26, 27, -86, -89, 43}, arrby));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioConfig.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel hwParcel, int n2) throws RemoteException {
            block39 : {
                ...
                block36 : {
                    ...
                    block37 : {
                        ...
                        if (n != 1) {
                            ...
                            object.enforceInterface(IRadioConfig.kInterfaceName);
                            this.setSimSlotsMapping(object.readInt32(), object.readInt32Vector());
                        }
                        break block39;
                    }
                    n = n4;
                    ...
                    if (n != 1) {
                        ...
                        object.enforceInterface(IRadioConfig.kInterfaceName);
                        this.getSimSlotsStatus(object.readInt32());
                    }
                    break block39;
                }
                n = (n2 & 1) != 0 ? n3 : 0;
                if (n != 0) {
                    ...
                    object.enforceInterface(IRadioConfig.kInterfaceName);
                    this.setResponseFunctions(IRadioConfigResponse.asInterface(object.readStrongBinder()), IRadioConfigIndication.asInterface(object.readStrongBinder()));
                    hwParcel.writeStatus(0);
                    hwParcel.send();
                }
            }
