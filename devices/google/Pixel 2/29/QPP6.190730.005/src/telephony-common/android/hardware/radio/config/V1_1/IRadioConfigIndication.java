...
extends android.hardware.radio.config.V1_0.IRadioConfigIndication {
    ...
    implements IRadioConfigIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({127, -49, 22, 127, 89, 59, 16, -58, 123, 89, -85, 112, 50, 23, -127, -62, 106, 85, 117, -22, -74, 8, 3, -25, -53, -79, -63, 76, 113, 8, 90, 59}, {34, -117, 46, -29, -56, -62, 118, -55, -16, -81, -83, 45, -61, 19, -54, 61, 107, -67, -98, 72, 45, -33, 49, 60, 114, 4, -58, 10, -39, -74, 54, -85}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioConfigIndication.kInterfaceName, "android.hardware.radio.config@1.0::IRadioConfigIndication", "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel hwParcel, int n2) throws RemoteException {
            ...
            switch (n) {
                ...
                case 1: {
                    ...
                    this.simSlotsStatusChanged(object.readInt32(), SimSlotStatus.readVectorFromParcel(object));
                }
            }
        }
