...
public interface IOemHookResponse
extends IBase {
    public static final String kInterfaceName = "android.hardware.radio.deprecated@1.0::IOemHookResponse";

    public static IOemHookResponse asInterface(IHwBinder object) {
        if (object == null) {
            return null;
        }
        Object object2 = object.queryLocalInterface(kInterfaceName);
        if (object2 != null && object2 instanceof IOemHookResponse) {
            return (IOemHookResponse)object2;
        }
    ...
    public static IOemHookResponse castFrom(IHwInterface object) {
        object = object == null ? null : IOemHookResponse.asInterface(object.asBinder());
        return object;
    }

    public static IOemHookResponse getService() throws RemoteException {
        return IOemHookResponse.getService("default");
    }

    public static IOemHookResponse getService(String string) throws RemoteException {
        return IOemHookResponse.asInterface(HwBinder.getService((String)kInterfaceName, (String)string));
    }

    public static IOemHookResponse getService(String string, boolean bl) throws RemoteException {
        return IOemHookResponse.asInterface(HwBinder.getService((String)kInterfaceName, (String)string, (boolean)bl));
    }

    public static IOemHookResponse getService(boolean bl) throws RemoteException {
        return IOemHookResponse.getService("default", bl);
    }
    ...
    public void sendRequestRawResponse(RadioResponseInfo var1, ArrayList<Byte> var2) throws RemoteException;

    public void sendRequestStringsResponse(RadioResponseInfo var1, ArrayList<String> var2) throws RemoteException;
    ...
    implements IOemHookResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({111, -44, -121, 79, 14, -35, -44, 98, 106, 39, 101, -113, -39, 79, -83, 82, 108, 49, 127, 53, 99, 67, -98, 121, 113, -117, -37, 26, 58, 35, 9, -43}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IOemHookResponse.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
            ...
            block36 : {
                ...
                block34 : {
                    ...
                    if (n != 1) {
                        ...
                        object.enforceInterface(IOemHookResponse.kInterfaceName);
                        hwParcel = new RadioResponseInfo();
                        hwParcel.readFromParcel((HwParcel)object);
                        this.sendRequestStringsResponse((RadioResponseInfo)hwParcel, object.readStringVector());
                    }
                    break block36;
                }
                n = n3;
                ...
                if (n != 1) {
                    ...
                    hwParcel = new RadioResponseInfo();
                    hwParcel.readFromParcel((HwParcel)object);
                    this.sendRequestRawResponse((RadioResponseInfo)hwParcel, object.readInt8Vector());
                }
            }
        }
        ...
        public IHwInterface queryLocalInterface(String string) {
            if (IOemHookResponse.kInterfaceName.equals(string)) {
                return this;
            }
            return null;
        }
