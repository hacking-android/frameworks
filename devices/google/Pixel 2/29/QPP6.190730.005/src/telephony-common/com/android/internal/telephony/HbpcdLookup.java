...
public class HbpcdLookup {
    ...
    public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup");
    ...
    implements BaseColumns {
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/arbitrary");
    ...
    implements BaseColumns {
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/idd");
        public static final String DEFAULT_SORT_ORDER = "MCC ASC";
    ...
    implements BaseColumns {
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/lookup");
    ...
    implements BaseColumns {
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/conflict");
        public static final String DEFAULT_SORT_ORDER = "MCC ASC";
        public static final String MCC = "MCC";
    ...
    implements BaseColumns {
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/range");
        public static final String DEFAULT_SORT_ORDER = "MCC ASC";
        public static final String MCC = "MCC";
    ...
    implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse((String)"content://hbpcd_lookup/nanp");
