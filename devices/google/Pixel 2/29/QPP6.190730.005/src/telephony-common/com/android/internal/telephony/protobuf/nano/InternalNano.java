...
public final class InternalNano {
    ...
    public static byte[] bytesDefaultValue(String string) {
    ...
    public static <K, V> int computeMapFieldSize(Map<K, V> map, int n, int n2, int n3) {
        int n4 = 0;
        ...
        while (iterator.hasNext()) {
            ...
            if (map != null && entry != null) {
                n4 = CodedOutputByteBufferNano.computeFieldSize(1, n2, map) + CodedOutputByteBufferNano.computeFieldSize(2, n3, entry);
    ...
    public static byte[] copyFromUtf8(String string) {
        return string.getBytes(UTF_8);
    }

    public static <K, V> boolean equals(Map<K, V> entry2, Map<K, V> map) {
        boolean bl = true;
        boolean bl2 = true;
        if (entry2 == map) {
            return true;
        ...
        for (Map.Entry<K, V> entry2 : entry2.entrySet()) {
            ...
            if (InternalNano.equalsMapValue(entry2.getValue(), map.get(entry2.getKey()))) continue;
            return false;
        }
        return true;
    }
    ...
    public static <K, V> int hashCode(Map<K, V> object) {
        if (object == null) {
            return 0;
        }
        int n = 0;
    ...
    public static <K, V> void serializeMapField(CodedOutputByteBufferNano codedOutputByteBufferNano, Map<K, V> map, int n, int n2, int n3) throws IOException {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            map = entry.getKey();
            entry = entry.getValue();
            if (map != null && entry != null) {
                int n4 = CodedOutputByteBufferNano.computeFieldSize(1, n2, map);
                int n5 = CodedOutputByteBufferNano.computeFieldSize(2, n3, entry);
                codedOutputByteBufferNano.writeTag(n, 2);
                codedOutputByteBufferNano.writeRawVarint32(n4 + n5);
                codedOutputByteBufferNano.writeField(1, n2, map);
                codedOutputByteBufferNano.writeField(2, n3, entry);
                continue;
            }
            throw new IllegalStateException("keys and values in maps cannot be null");
        }
