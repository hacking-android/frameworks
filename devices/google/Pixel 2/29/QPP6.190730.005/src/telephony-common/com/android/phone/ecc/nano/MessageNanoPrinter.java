...
public final class MessageNanoPrinter {
    ...
    public static <T extends MessageNano> String print(T object) {
        ...
        try {
            ...
            ((StringBuilder)abstractStringBuilder).append("Error printing proto: ");
            ((StringBuilder)abstractStringBuilder).append(illegalAccessException.getMessage());
    ...
    private static void print(String string, Object iterator, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        for (n3 = 0; n3 < i; ++n3) {
            ...
            if ("cachedSize".equals(object) || (n2 & 1) != 1 || (n2 & 8) == 8 || ((String)object).startsWith("_") || ((String)object).endsWith("_")) continue;
            noSuchMethodException = field.getType();
            Object object2 = field.get(iterator);
            if (((Class)noSuchMethodException).isArray()) {
                if (((Class)noSuchMethodException).getComponentType() == Byte.TYPE) {
                    MessageNanoPrinter.print((String)object, object2, stringBuffer, stringBuffer2);
                    continue;
                }
                n2 = object2 == null ? 0 : Array.getLength(object2);
                for (i = 0; i < n2; ++i) {
                    MessageNanoPrinter.print((String)object, Array.get(object2, i), stringBuffer, stringBuffer2);
                }
                continue;
            }
            MessageNanoPrinter.print((String)object, object2, stringBuffer, stringBuffer2);
        ...
        do {
            block25 : {
                ...
                if (((String)noSuchMethodException).startsWith("set")) {
                    noSuchMethodException = ((String)noSuchMethodException).substring(3);
                    object = new StringBuilder();
                    ((StringBuilder)object).append("has");
                    ((StringBuilder)object).append((String)noSuchMethodException);
                    ...
                    MessageNanoPrinter.print((String)noSuchMethodException, ((Method)object).invoke(iterator, new Object[0]), stringBuffer, stringBuffer2);
                    break block25;
                    catch (NoSuchMethodException noSuchMethodException3) {
                        // empty catch block
                    }
