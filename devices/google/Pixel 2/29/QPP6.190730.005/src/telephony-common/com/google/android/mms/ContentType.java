...
public class ContentType {
    ...
    public static boolean isAudioType(String string) {
        boolean bl = string != null && string.startsWith("audio/");
        return bl;
    }

    public static boolean isDrmType(String string) {
        boolean bl = string != null && (string.equals(APP_DRM_CONTENT) || string.equals(APP_DRM_MESSAGE));
        return bl;
    }

    public static boolean isImageType(String string) {
        boolean bl = string != null && string.startsWith("image/");
        return bl;
    }

    public static boolean isSupportedAudioType(String string) {
        boolean bl = ContentType.isAudioType(string) && ContentType.isSupportedType(string);
        return bl;
    }

    public static boolean isSupportedImageType(String string) {
        boolean bl = ContentType.isImageType(string) && ContentType.isSupportedType(string);
        return bl;
    }

    public static boolean isSupportedType(String string) {
        boolean bl = string != null && sSupportedContentTypes.contains(string);
        return bl;
    }

    public static boolean isSupportedVideoType(String string) {
        boolean bl = ContentType.isVideoType(string) && ContentType.isSupportedType(string);
        return bl;
    }

    public static boolean isTextType(String string) {
        boolean bl = string != null && string.startsWith("text/");
        return bl;
    }
