...
import com.android.phone.ecc.nano.UnknownFieldData;
...
public class Extension<M extends ExtendableMessageNano<M>, T> {
    ...
    protected Object readData(CodedInputByteBufferNano object) {
        ...
        try {
            ...
            object = new StringBuilder();
            ((StringBuilder)object).append("Error creating instance of class ");
            ...
            ((StringBuilder)object).append("Error creating instance of class ");
            ((StringBuilder)object).append(class_);
            throw new IllegalArgumentException(((StringBuilder)object).toString(), instantiationException);
        }
    }
