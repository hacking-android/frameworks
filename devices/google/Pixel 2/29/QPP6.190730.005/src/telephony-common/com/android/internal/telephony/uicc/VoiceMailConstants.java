...
class VoiceMailConstants {
    ...
    boolean containsCarrier(String string) {
        return this.CarrierVmMap.containsKey(string);
    }

    String getCarrierName(String string) {
        return this.CarrierVmMap.get(string)[0];
    }

    String getVoiceMailNumber(String string) {
        return this.CarrierVmMap.get(string)[1];
    }

    String getVoiceMailTag(String string) {
        return this.CarrierVmMap.get(string)[2];
    }
}
