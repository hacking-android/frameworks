...
implements EncodableDigest {
    ...
    public int doFinal(byte[] arrby, int n) {
        ...
        Pack.intToBigEndian(this.H8, arrby, n + 28);
        this.reset();
        return 32;
    }
    ...
    protected void processBlock() {
        ...
        for (n = 0; n < 8; ++n) {
            ...
            n2 += (n6 += this.Sum1(n3) + this.Ch(n3, n8, n9) + K[++n10] + this.X[n10]);
            n6 += this.Sum0(n7) + this.Maj(n7, n4, n5);
            n11 = n9 + (this.Sum1(n2) + this.Ch(n2, n3, n8) + K[++n10] + this.X[n10]);
            n9 = n5 + n11;
            n5 = n11 + (this.Sum0(n6) + this.Maj(n6, n7, n4));
            n11 = n8 + (this.Sum1(n9) + this.Ch(n9, n2, n3) + K[++n10] + this.X[n10]);
            n8 = n4 + n11;
            n4 = n11 + (this.Sum0(n5) + this.Maj(n5, n6, n7));
