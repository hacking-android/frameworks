...
public class SecP256K1Field {
    ...
    public static void addExt(int[] arrn, int[] arrn2, int[] arrn3) {
        if ((Nat.add(16, arrn, arrn2, arrn3) != 0 || arrn3[15] == -1 && Nat.gte(16, arrn3, PExt)) && Nat.addTo((arrn = PExtInv).length, arrn, arrn3) != 0) {
    ...
    public static void multiplyAddToExt(int[] arrn, int[] arrn2, int[] arrn3) {
        if ((Nat256.mulAddTo(arrn, arrn2, arrn3) != 0 || arrn3[15] == -1 && Nat.gte(16, arrn3, PExt)) && Nat.addTo((arrn = PExtInv).length, arrn, arrn3) != 0) {
            Nat.incAt(16, arrn3, PExtInv.length);
        }
    }
    ...
    public static void subtractExt(int[] arrn, int[] arrn2, int[] arrn3) {
        if (Nat.sub(16, arrn, arrn2, arrn3) != 0 && Nat.subFrom((arrn = PExtInv).length, arrn, arrn3) != 0) {
