...
extends XResourceBundle {
    ...
    public Object[][] getContents() {
        ...
        return new Object[][]{{"ui_language", "de"}, {"help_language", "de"}, {"language", "de"}, {"alphabet", charArrayWrapper}, {"tradAlphabet", charArrayWrapper2}, {"orientation", "LeftToRight"}, {"numbering", "additive"}};
    }
}
