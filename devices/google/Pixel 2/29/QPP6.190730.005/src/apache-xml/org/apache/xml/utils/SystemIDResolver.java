...
public class SystemIDResolver {
    ...
    public static String getAbsoluteURI(String object, String object2) throws TransformerException {
        if (object2 == null) {
            return SystemIDResolver.getAbsoluteURI((String)object);
        }
        String string = SystemIDResolver.getAbsoluteURI((String)object2);
        try {
            object2 = new URI(string);
            object = new URI((URI)object2, (String)object);
        }
