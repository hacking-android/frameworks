...
implements Serializable {
    ...
    private void initialize(URI object, String object2) throws MalformedURIException {
        block24 : {
                ...
                block27 : {
                    block28 : {
                        block25 : {
                            ...
                            if (object2 == null || ((String)object2).trim().length() == 0) break block24;
                            object2 = ((String)object2).trim();
                            n = ((String)object2).length();
                            n3 = 0;
                            n2 = ((String)object2).indexOf(58);
                            if (n2 >= 0) break block25;
                            if (object == null) {
                                throw new MalformedURIException(XMLMessages.createXMLMessage("ER_NO_SCHEME_IN_URI", new Object[]{object2}));
                            }
                            break block26;
                        }
                        this.initializeScheme((String)object2);
                        string = ((String)object2).substring(n2 + 1);
                        object2 = object;
                        if (this.m_scheme == null) break block27;
                        object2 = object;
                        if (object == null) break block27;
                        if (string.startsWith("/") || !this.m_scheme.equals(((URI)object).m_scheme)) break block28;
                        object2 = object;
                        if (((URI)object).getSchemeSpecificPart().startsWith("/")) break block27;
                    }
                    object2 = null;
                }
                n = string.length();
            ...
            if (((String)object2).startsWith("//")) {
                char c;
                for (n3 = n2 = 0 + 2; n3 < n && (c = ((String)object2).charAt(n3)) != '/' && c != '?' && c != '#'; ++n3) {
                }
                if (n3 > n2) {
                    this.initializeAuthority(((String)object2).substring(n2, n3));
                } else {
                    this.m_host = "";
                }
            }
            this.initializePath(((String)object2).substring(n3));
            if (object != null) {
                ...
                if (this.m_host == null) {
                    ...
                    object2 = new String();
                    string = ((URI)object).getPath();
                    object = object2;
                    if (string != null) {
                        n3 = string.lastIndexOf(47);
                        object = object2;
                        if (n3 != -1) {
                            object = string.substring(0, n3 + 1);
                        }
                    }
                    object2 = ((String)object).concat(this.m_path);
                    while ((n3 = ((String)object2).indexOf("/./")) != -1) {
                        object2 = ((String)object2).substring(0, n3 + 1).concat(((String)object2).substring(n3 + 3));
                    }
                    object = object2;
                    ...
                    while ((n = ((String)object).indexOf("/../")) > 0) {
                        ...
                        if (n3 == -1 || ((String)object2).substring(n3).equals("..")) continue;
                        object = ((String)object).substring(0, n3 + 1).concat(((String)object).substring(n + 4));
                    }
                    object2 = object;
                    if (((String)object).endsWith("/..")) {
                        n3 = ((String)object).substring(0, ((String)object).length() - 3).lastIndexOf(47);
                        object2 = object;
                        if (n3 != -1) {
                            object2 = ((String)object).substring(0, n3 + 1);
                        }
                    }
                    this.m_path = object2;
                } else {
        ...
        if (charSequence != null) {
            ...
            for (n = 0; n < n3; ++n) {
                ...
                if (n2 == 37) {
                    ...
                    throw new MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_INVALID_CHAR", new Object[]{String.valueOf((char)n2)}));
                }
                n4 = n2;
            }
    ...
    public void appendPath(String string) throws MalformedURIException {
        if (string != null && string.trim().length() != 0) {
            ...
            throw new MalformedURIException(XMLMessages.createXMLMessage("ER_PATH_INVALID_CHAR", new Object[]{string}));
        }
    }
