...
class ObjectFactory {
    ...
    static Object createObject(String string, String object, String string2) throws ConfigurationError {
        if ((object = ObjectFactory.lookUpFactoryClass(string, (String)object, string2)) != null) {
            try {
                string2 = ((Class)object).newInstance();
                ...
                object = new StringBuilder();
                ((StringBuilder)object).append("Provider for factory ");
                ((StringBuilder)object).append(string);
    ...
    private static String findJarServiceProviderName(String object) {
        ...
        ((StringBuilder)object2).append(SERVICES_PATH);
        ((StringBuilder)object2).append((String)object);
        String string = ((StringBuilder)object2).toString();
        Object object3 = ObjectFactory.findClassLoader();
        InputStream inputStream = securitySupport.getResourceAsStream((ClassLoader)object3, string);
        object = inputStream;
        object2 = object3;
        if (inputStream == null) {
            ...
            object = inputStream;
            object2 = object3;
            if (object3 != classLoader) {
                object2 = classLoader;
                object = securitySupport.getResourceAsStream((ClassLoader)object2, string);
            }
        }
        if (object == null) {
            return null;
        ...
        ((StringBuilder)object3).append("found jar resource=");
        ((StringBuilder)object3).append(string);
        ((StringBuilder)object3).append(" using ClassLoader: ");
        ((StringBuilder)object3).append(object2);
        ObjectFactory.debugPrintln(((StringBuilder)object3).toString());
        try {
            object3 = new InputStreamReader((InputStream)object, "UTF-8");
            object = object2 = new BufferedReader((Reader)object3);
        }
    ...
    static Class lookUpFactoryClass(String string, String object, String charSequence) throws ConfigurationError {
        object = ObjectFactory.lookUpFactoryClassName(string, (String)object, (String)charSequence);
        ...
        try {
            ...
            throw new ConfigurationError(((StringBuilder)charSequence).toString(), classNotFoundException);
        }
    }
            ...
            block38 : {
                block35 : {
                    block37 : {
                                ...
                                block40 : {
                                    block33 : {
                                        block34 : {
                                            ...
                                            try {
                                                var1_3 = var4_15.getSystemProperty((String)var0);
                                                if (var1_3 != null) {
                                                    var2_9 = new StringBuilder();
                                                    var2_9.append("found system property, value=");
                                                    var2_9.append((String)var1_3);
                                                    ObjectFactory.debugPrintln(var2_9.toString());
                                                    return var1_3;
                                                }
                                            }
                                            ...
                                            var7_18 = null;
                                            var8_19 = null;
                                            if (var3_13 != null) break block39;
                                            var2_9 = null;
                                            var9_20 = null;
                                            var10_22 = false;
                                            var1_3 = var4_15.getSystemProperty("java.home");
                                            var5_16 = new StringBuilder();
                                            var5_16.append((String)var1_3);
                                            var5_16.append(File.separator);
                                            var5_16.append("lib");
                                            var5_16.append(File.separator);
                                            var5_16.append("xalan.properties");
                                            var2_9 = var1_3 = var5_16.toString();
                                            var1_3 = var9_20;
                                            try {
                                                var1_3 = var9_20;
                                                var1_3 = var3_13 = new File((String)var2_9);
                                                var10_22 = var11_23 = var4_15.getFileExists((File)var3_13);
                                                var1_3 = var2_9;
                                                var9_20 = var3_13;
                                                break block33;
                                            }
                                            catch (SecurityException var3_14) {
                                                var3_13 = var2_9;
                                                var2_9 = var1_3;
                                                break block34;
                                            }
                                    ...
                                    // MONITORENTER : org.apache.xalan.xslt.ObjectFactory.class
                                    var12_24 = false;
                                    var13_25 = false;
                                    var14_26 = false;
                                    var5_16 = null;
                        ...
                        var1_3 = var9_21;
                        var2_9 = var8_19;
                        var22_32 = new File((String)var3_13);
                        var1_3 = var9_21;
                        var2_9 = var8_19;
                ...
                // MONITOREXIT : org.apache.xalan.xslt.ObjectFactory.class
                var3_13 = ObjectFactory.fXalanProperties;
                var2_9 = var8_19;
                if (var3_13 != null) {
                    var2_9 = var3_13.getProperty((String)var0);
                }
                var8_19 = var1_3;
                var1_3 = var2_9;
                break block36;
            }
            if (var2_9 == null) throw var0_1;
            try {
                var2_9.close();
                throw var0_1;
            }
