...
class Huffman {
    ...
    private void addCode(int n, int n2, byte by) {
        ...
        while (by > 8) {
            ...
            if (node2.children != null) {
                if (node2.children[n] == null) {
                    Node.access$000((Node)node2)[n] = new Node();
                }
        ...
        by = (byte)(8 - by);
        for (n = n2 = n2 << by & 255; n < n2 + (1 << by); ++n) {
            Node.access$000((Node)node2)[n] = node;
        }
    }

    private void buildTree() {
        byte[] arrby;
        for (int i = 0; i < (arrby = CODE_LENGTHS).length; ++i) {
            this.addCode(i, CODES[i], arrby[i]);
        }
    }
    ...
    byte[] decode(byte[] object) throws IOException {
        ...
        do {
            ...
            n2 += 8;
            while (n2 >= 8) {
                if ((node2 = node2.children[n >>> n2 - 8 & 255]).children == null) {
        ...
        for (int i = n2; i > 0 && ((Node)(object = node.children[n << 8 - i & 255])).children == null && ((Node)object).terminalBits <= i; i -= Node.access$200((Node)object)) {
