...
public abstract class CameraMetadata<TKey> {
    ...
    private static <TKey> boolean shouldKeyBeAdded(TKey object, Field field, int[] arrn, boolean bl) {
        block6 : {
            block10 : {
                block8 : {
                    block9 : {
                        block7 : {
                            ...
                            if (!(object instanceof CameraCharacteristics.Key)) break block7;
                            object = ((CameraCharacteristics.Key)object).getNativeKey();
                            break block8;
                        }
                        if (!(object instanceof CaptureResult.Key)) break block9;
                        object = ((CaptureResult.Key)object).getNativeKey();
                        break block8;
                    }
                    if (!(object instanceof CaptureRequest.Key)) break block10;
                    object = ((CaptureRequest.Key)object).getNativeKey();
                }
                ...
                bl = Arrays.binarySearch(arrn, ((CameraMetadataNative.Key)object).getTag()) >= 0 ? bl2 : false;
                return bl;
            }
     ...
     */
    <TKey> ArrayList<TKey> getKeys(Class<?> object, Class<TKey> class_, CameraMetadata<TKey> object2, int[] arrn, boolean bl) {
        void var6_10;
        Object object32 = object;
        if (object.equals(TotalCaptureResult.class)) {
            Class<CaptureResult> class_2 = CaptureResult.class;
        }
        if (arrn != null) {
            Arrays.sort(arrn);
        }
        ArrayList<Object> arrayList = new ArrayList<Object>();
        for (Field field : var6_10.getDeclaredFields()) {
            Object object3;
            if (!field.getType().isAssignableFrom(class_) || (field.getModifiers() & 1) == 0) continue;
            try {
            ...
            if (object2 != null && ((CameraMetadata)((Object)object2)).getProtected((Object)object3) == null || !CameraMetadata.shouldKeyBeAdded(object3, field, arrn, bl)) continue;
            arrayList.add(object3);
        }
        object = this.mNativeInstance;
        if (object == null) {
            return arrayList;
        }
        if ((object = ((CameraMetadataNative)object).getAllVendorKeys(class_)) != null) {
            object2 = ((ArrayList)object).iterator();
            while (object2.hasNext()) {
                long l;
                class_ = object2.next();
                if (class_ instanceof CaptureRequest.Key) {
                    object = ((CaptureRequest.Key)((Object)class_)).getName();
                    l = ((CaptureRequest.Key)((Object)class_)).getVendorId();
                } else if (class_ instanceof CaptureResult.Key) {
                    object = ((CaptureResult.Key)((Object)class_)).getName();
                    l = ((CaptureResult.Key)((Object)class_)).getVendorId();
                } else {
                    if (!(class_ instanceof CameraCharacteristics.Key)) continue;
                    object = ((CameraCharacteristics.Key)((Object)class_)).getName();
                    l = ((CameraCharacteristics.Key)((Object)class_)).getVendorId();
                }
                if (arrn != null && Arrays.binarySearch(arrn, CameraMetadataNative.getTag((String)object, l)) < 0) continue;
    ...
    public List<TKey> getKeys() {
        ...
        return Collections.unmodifiableList(this.getKeys(class_, this.getKeyClass(), this, null, true));
    }

    protected abstract <T> T getProtected(TKey var1);
