...
extends IInterface {
    @UnsupportedAppUsage
    public void packageDeleted(String var1, int var2) throws RemoteException;
    ...
    implements IPackageDeleteObserver {
        ...
        @Override
        public void packageDeleted(String string2, int n) throws RemoteException {
        }
    }
    ...
    implements IPackageDeleteObserver {
        ...
        public static boolean setDefaultImpl(IPackageDeleteObserver iPackageDeleteObserver) {
            if (Proxy.sDefaultImpl == null && iPackageDeleteObserver != null) {
                Proxy.sDefaultImpl = iPackageDeleteObserver;
                return true;
            }
            return false;
        }
        ...
        public boolean onTransact(int n, Parcel parcel, Parcel parcel2, int n2) throws RemoteException {
            ...
            this.packageDeleted(parcel.readString(), parcel.readInt());
            return true;
        }
            ...
            public void packageDeleted(String string2, int n) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, parcel, null, 1) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().packageDeleted(string2, n);
                        return;
                    }
                    return;
                }
