...
extends IBase {
    ...
    public void callRing(int var1, boolean var2, CdmaSignalInfoRecord var3) throws RemoteException;

    public void callStateChanged(int var1) throws RemoteException;

    public void cdmaCallWaiting(int var1, CdmaCallWaiting var2) throws RemoteException;

    public void cdmaInfoRec(int var1, CdmaInformationRecords var2) throws RemoteException;

    public void cdmaNewSms(int var1, CdmaSmsMessage var2) throws RemoteException;

    public void cdmaOtaProvisionStatus(int var1, int var2) throws RemoteException;

    public void cdmaPrlChanged(int var1, int var2) throws RemoteException;

    public void cdmaRuimSmsStorageFull(int var1) throws RemoteException;

    public void cdmaSubscriptionSourceChanged(int var1, int var2) throws RemoteException;

    public void cellInfoList(int var1, ArrayList<CellInfo> var2) throws RemoteException;

    public void currentSignalStrength(int var1, SignalStrength var2) throws RemoteException;

    public void dataCallListChanged(int var1, ArrayList<SetupDataCallResult> var2) throws RemoteException;

    @Override
    public void debug(NativeHandle var1, ArrayList<String> var2) throws RemoteException;

    public void enterEmergencyCallbackMode(int var1) throws RemoteException;
    ...
    public void hardwareConfigChanged(int var1, ArrayList<HardwareConfig> var2) throws RemoteException;

    public void imsNetworkStateChanged(int var1) throws RemoteException;

    public void indicateRingbackTone(int var1, boolean var2) throws RemoteException;
    ...
    public void lceData(int var1, LceDataInfo var2) throws RemoteException;

    @Override
    public boolean linkToDeath(IHwBinder.DeathRecipient var1, long var2) throws RemoteException;

    public void modemReset(int var1, String var2) throws RemoteException;

    public void networkStateChanged(int var1) throws RemoteException;

    public void newBroadcastSms(int var1, ArrayList<Byte> var2) throws RemoteException;

    public void newSms(int var1, ArrayList<Byte> var2) throws RemoteException;

    public void newSmsOnSim(int var1, int var2) throws RemoteException;

    public void newSmsStatusReport(int var1, ArrayList<Byte> var2) throws RemoteException;

    public void nitzTimeReceived(int var1, String var2, long var3) throws RemoteException;

    @Override
    public void notifySyspropsChanged() throws RemoteException;

    public void onSupplementaryServiceIndication(int var1, StkCcUnsolSsResult var2) throws RemoteException;

    public void onUssd(int var1, int var2, String var3) throws RemoteException;

    public void pcoData(int var1, PcoDataInfo var2) throws RemoteException;

    @Override
    public void ping() throws RemoteException;

    public void radioCapabilityIndication(int var1, RadioCapability var2) throws RemoteException;

    public void radioStateChanged(int var1, int var2) throws RemoteException;

    public void resendIncallMute(int var1) throws RemoteException;

    public void restrictedStateChanged(int var1, int var2) throws RemoteException;

    public void rilConnected(int var1) throws RemoteException;

    @Override
    public void setHALInstrumentation() throws RemoteException;

    public void simRefresh(int var1, SimRefreshResult var2) throws RemoteException;

    public void simSmsStorageFull(int var1) throws RemoteException;

    public void simStatusChanged(int var1) throws RemoteException;

    public void srvccStateNotify(int var1, int var2) throws RemoteException;

    public void stkCallControlAlphaNotify(int var1, String var2) throws RemoteException;

    public void stkCallSetup(int var1, long var2) throws RemoteException;

    public void stkEventNotify(int var1, String var2) throws RemoteException;

    public void stkProactiveCommand(int var1, String var2) throws RemoteException;

    public void stkSessionEnd(int var1) throws RemoteException;

    public void subscriptionStatusChanged(int var1, boolean var2) throws RemoteException;

    public void suppSvcNotify(int var1, SuppSvcNotification var2) throws RemoteException;

    @Override
    public boolean unlinkToDeath(IHwBinder.DeathRecipient var1) throws RemoteException;

    public void voiceRadioTechChanged(int var1, int var2) throws RemoteException;
    ...
    implements IRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            ...
            return new ArrayList<byte[]>(Arrays.asList({92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, -96, 29, -128, -120, -42, -36, -55, 2, 14, 82, -46, -59}, arrby));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioIndication.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
