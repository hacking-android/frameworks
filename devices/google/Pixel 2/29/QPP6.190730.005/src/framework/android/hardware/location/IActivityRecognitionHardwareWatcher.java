...
extends IInterface {
    public void onInstanceChanged(IActivityRecognitionHardware var1) throws RemoteException;
    ...
    implements IActivityRecognitionHardwareWatcher {
        ...
        public static boolean setDefaultImpl(IActivityRecognitionHardwareWatcher iActivityRecognitionHardwareWatcher) {
            if (Proxy.sDefaultImpl == null && iActivityRecognitionHardwareWatcher != null) {
                Proxy.sDefaultImpl = iActivityRecognitionHardwareWatcher;
                return true;
            }
            return false;
        }
        ...
        public boolean onTransact(int n, Parcel parcel, Parcel parcel2, int n2) throws RemoteException {
            ...
            this.onInstanceChanged(IActivityRecognitionHardware.Stub.asInterface(parcel.readStrongBinder()));
            ...
            public void onInstanceChanged(IActivityRecognitionHardware iActivityRecognitionHardware) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, parcel, parcel2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onInstanceChanged(iActivityRecognitionHardware);
                        return;
                    }
