...
public final class CellInfoCdma {
    ...
    public static final ArrayList<CellInfoCdma> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            ((CellInfoCdma)object).readEmbeddedFromParcel(hwParcel, hwBlob, i * 40);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        ...
        this.signalStrengthCdma.readEmbeddedFromParcel(hwParcel, hwBlob, 20L + l);
        this.signalStrengthEvdo.readEmbeddedFromParcel(hwParcel, hwBlob, 28L + l);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long l) {
        ...
        this.signalStrengthCdma.writeEmbeddedToBlob(hwBlob, 20L + l);
        this.signalStrengthEvdo.writeEmbeddedToBlob(hwBlob, 28L + l);
    }
