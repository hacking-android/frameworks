...
import android.telephony._$$Lambda$DataFailCause$djkZSxdG_s_w2L5rQKiGu6OudyY;
...
public final class DataFailCause {
    ...
    private static final Map<Integer, String> sFailCauseMap = new HashMap<Integer, String>();
    ...
    public static int getFailCause(int n) {
        if (sFailCauseMap.containsKey(n)) {
            return n;
        }
        return 65536;
    }

    public static boolean isEventLoggable(int n) {
        boolean bl = n == 8 || n == 26 || n == 28 || n == 29 || n == 30 || n == 31 || n == 33 || n == 32 || n == 34 || n == 35 || n == 50 || n == 51 || n == 111 || n == -3 || n == -5 || n == -6 || n == 65538;
        return bl;
    }
     ...
     */
    public static boolean isPermanentFailure(Context entry, int n, int n2) {
        HashMap<Integer, Set<Integer>> hashMap = sPermanentFailureCache;
        synchronized (hashMap) {
            HashSet<Integer> hashSet = sPermanentFailureCache.get(n2);
            Object object = hashSet;
            if (hashSet != null) return object.contains(n);
            object = (CarrierConfigManager)((Context)((Object)entry)).getSystemService("carrier_config");
            entry = hashSet;
            if (object != null) {
                object = object.getConfigForSubId(n2);
                entry = hashSet;
                if (object != null) {
                    object = object.getStringArray("carrier_data_call_permanent_failure_strings");
                    entry = hashSet;
                    if (object != null) {
                        hashSet = new HashSet<Integer>();
                        Iterator<Map.Entry<Integer, String>> iterator = sFailCauseMap.entrySet().iterator();
                        do {
                            entry = hashSet;
                            if (!iterator.hasNext()) break;
                            entry = iterator.next();
                            if (!ArrayUtils.contains(object, (String)entry.getValue())) continue;
            ...
            sPermanentFailureCache.put(n2, (Set<Integer>)hashSet);
            object = hashSet;
            return object.contains(n);
        }
    }

    public static boolean isRadioRestartFailure(Context arrn, int n, int n2) {
        if ((arrn = (CarrierConfigManager)arrn.getSystemService("carrier_config")) != null && (arrn = arrn.getConfigForSubId(n2)) != null) {
            if (n == 36 && arrn.getBoolean("restart_radio_on_pdp_fail_regular_deactivation_bool")) {
                return true;
            }
            if ((arrn = arrn.getIntArray("radio_restart_failure_causes_int_array")) != null) {
                return Arrays.stream(arrn).anyMatch(new _$$Lambda$DataFailCause$djkZSxdG_s_w2L5rQKiGu6OudyY(n));
            }
        }
        return false;
    }

    static /* synthetic */ boolean lambda$isRadioRestartFailure$0(int n, int n2) {
        boolean bl = n2 == n;
        return bl;
    }
    ...
    public static String toString(int n) {
        ...
        int n2 = DataFailCause.getFailCause(n);
        if (n2 == 65536) {
            ...
            charSequence = sFailCauseMap.get(n2);
        }
        return charSequence;
    }
