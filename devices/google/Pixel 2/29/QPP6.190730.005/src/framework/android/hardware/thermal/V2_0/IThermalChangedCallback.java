...
public interface IThermalChangedCallback
extends IBase {
    public static final String kInterfaceName = "android.hardware.thermal@2.0::IThermalChangedCallback";

    public static IThermalChangedCallback asInterface(IHwBinder object) {
        if (object == null) {
            return null;
        }
        Object object2 = object.queryLocalInterface(kInterfaceName);
        if (object2 != null && object2 instanceof IThermalChangedCallback) {
            return (IThermalChangedCallback)object2;
        }
    ...
    public static IThermalChangedCallback castFrom(IHwInterface iHwInterface) {
        iHwInterface = iHwInterface == null ? null : IThermalChangedCallback.asInterface(iHwInterface.asBinder());
        return iHwInterface;
    }

    public static IThermalChangedCallback getService() throws RemoteException {
        return IThermalChangedCallback.getService("default");
    }

    public static IThermalChangedCallback getService(String string2) throws RemoteException {
        return IThermalChangedCallback.asInterface(HwBinder.getService(kInterfaceName, string2));
    }

    public static IThermalChangedCallback getService(String string2, boolean bl) throws RemoteException {
        return IThermalChangedCallback.asInterface(HwBinder.getService(kInterfaceName, string2, bl));
    }

    public static IThermalChangedCallback getService(boolean bl) throws RemoteException {
        return IThermalChangedCallback.getService("default", bl);
    }
    ...
    implements IThermalChangedCallback {
        ...
        @Override
        public void notifyThrottling(Temperature object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
    ...
    implements IThermalChangedCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({-52, 77, 46, -13, 109, -89, 118, -60, 117, -83, 5, 79, 15, 52, 22, -40, -88, -122, 93, -17, -99, -98, 33, 41, -15, 0, 116, -78, -114, 54, -46, 3}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IThermalChangedCallback.kInterfaceName, "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel object2, int n2) throws RemoteException {
            ...
            switch (n) {
                ...
                case 1: {
                    ...
                    ((HwParcel)object).enforceInterface(IThermalChangedCallback.kInterfaceName);
                    object2 = new Temperature();
                    ((Temperature)object2).readFromParcel((HwParcel)object);
                    this.notifyThrottling((Temperature)object2);
                }
            }
        }
        ...
        public IHwInterface queryLocalInterface(String string2) {
            if (IThermalChangedCallback.kInterfaceName.equals(string2)) {
                return this;
            }
            return null;
        }
