...
extends android.hardware.vibrator.V1_1.IVibrator {
    ...
    public static IVibrator asInterface(IHwBinder object) {
        ...
        if (object2 != null && object2 instanceof IVibrator) {
            return (IVibrator)object2;
        }
    ...
    public void perform_1_2(int var1, byte var2, perform_1_2Callback var3) throws RemoteException;
    ...
    implements IVibrator {
        ...
        @Override
        public void perform_1_2(int n, byte by, perform_1_2Callback perform_1_2Callback2) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        public void onTransact(int n, HwParcel object, final HwParcel hwParcel, int n2) throws RemoteException {
            ...
            block0 : switch (n) {
                ...
                case 7: {
                    ...
                    this.perform_1_2(((HwParcel)object).readInt32(), ((HwParcel)object).readInt8(), new perform_1_2Callback(){
                ...
                case 6: {
                    ...
                    ((HwParcel)object).enforceInterface("android.hardware.vibrator@1.1::IVibrator");
                    this.perform_1_1(((HwParcel)object).readInt32(), ((HwParcel)object).readInt8(), new IVibrator.perform_1_1Callback(){
