...
implements Parcelable {
    ...
    public static final Parcelable.Creator<ImsReasonInfo> CREATOR = new Parcelable.Creator<ImsReasonInfo>(){
        ...
        public ImsReasonInfo[] newArray(int n) {
            return new ImsReasonInfo[n];
        }
    };
    ...
    @UnsupportedAppUsage
    public ImsReasonInfo(int n, int n2) {
        this.mCode = n;
        this.mExtraCode = n2;
        this.mExtraMessage = null;
    }

    public ImsReasonInfo(int n, int n2, String string2) {
        this.mCode = n;
        this.mExtraCode = n2;
        this.mExtraMessage = string2;
    }
