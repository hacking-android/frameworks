...
extends android.hardware.radio.V1_1.IRadio {
    ...
    public void deactivateDataCall_1_2(int var1, int var2, int var3) throws RemoteException;
    ...
    public void setIndicationFilter_1_2(int var1, int var2) throws RemoteException;

    public void setLinkCapacityReportingCriteria(int var1, int var2, int var3, int var4, ArrayList<Integer> var5, ArrayList<Integer> var6, int var7) throws RemoteException;

    public void setSignalStrengthReportingCriteria(int var1, int var2, int var3, ArrayList<Integer> var4, int var5) throws RemoteException;

    public void setupDataCall_1_2(int var1, int var2, DataProfileInfo var3, boolean var4, boolean var5, boolean var6, int var7, ArrayList<String> var8, ArrayList<String> var9) throws RemoteException;

    public void startNetworkScan_1_2(int var1, NetworkScanRequest var2) throws RemoteException;
    ...
    implements IRadio {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({29, 25, 114, 13, 79, -45, -117, 16, -107, -16, -11, 85, -92, -67, -110, -77, -79, 44, -101, 29, 15, 86, 11, 14, -102, 71, 76, -42, -36, -62, 13, -74}, {-9, -98, -33, 80, -93, 120, -87, -55, -69, 115, 127, -109, -14, 5, -38, -71, 27, 76, 99, -22, 73, 114, 58, -4, 111, -123, 108, 19, -126, 3, -22, -127}, {-101, 90, -92, -103, -20, 59, 66, 38, -15, 95, 72, -11, -19, 8, -119, 110, 47, -64, 103, 111, -105, -116, -98, 25, -100, 29, -94, 29, -86, -16, 2, -90}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadio.kInterfaceName, "android.hardware.radio@1.1::IRadio", "android.hardware.radio@1.0::IRadio", "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel object2, int n2) throws RemoteException {
            ...
            block0 : switch (n) {
                ...
                case 141: {
                    ...
                    this.setupDataCall_1_2(n, n2, (DataProfileInfo)object2, ((HwParcel)object).readBool(), ((HwParcel)object).readBool(), ((HwParcel)object).readBool(), ((HwParcel)object).readInt32(), ((HwParcel)object).readStringVector(), ((HwParcel)object).readStringVector());
                    break;
                }
                case 140: {
                    n = n8;
                ...
                case 28: {
                    ...
                    object2 = new DataProfileInfo();
                    ((DataProfileInfo)object2).readFromParcel((HwParcel)object);
                    this.setupDataCall(n, n2, (DataProfileInfo)object2, ((HwParcel)object).readBool(), ((HwParcel)object).readBool(), ((HwParcel)object).readBool());
                    break;
                }
                case 27: {
                    n = n121;
