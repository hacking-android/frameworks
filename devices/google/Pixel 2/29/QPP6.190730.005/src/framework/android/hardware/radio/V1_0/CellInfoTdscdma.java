...
public final class CellInfoTdscdma {
    ...
    public static final ArrayList<CellInfoTdscdma> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            cellInfoTdscdma.readEmbeddedFromParcel(hwParcel, hwBlob, i * 56);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        ...
        this.signalStrengthTdscdma.readEmbeddedFromParcel(hwParcel, hwBlob, 48L + l);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long l) {
        ...
        this.signalStrengthTdscdma.writeEmbeddedToBlob(hwBlob, 48L + l);
    }
