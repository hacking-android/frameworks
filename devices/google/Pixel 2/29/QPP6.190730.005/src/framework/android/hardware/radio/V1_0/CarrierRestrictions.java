...
public final class CarrierRestrictions {
    ...
    public static final ArrayList<CarrierRestrictions> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<CarrierRestrictions> arrayList = new ArrayList<CarrierRestrictions>();
        ...
        for (int i = 0; i < n; ++i) {
            ...
            ((CarrierRestrictions)object).readEmbeddedFromParcel(hwParcel, hwBlob, i * 32);
            arrayList.add((CarrierRestrictions)object);
        }
        return arrayList;
    }
    ...
    public final boolean equals(Object object) {
        ...
        if (object.getClass() != CarrierRestrictions.class) {
            return false;
        }
        object = (CarrierRestrictions)object;
        if (!HidlSupport.deepEquals(this.allowedCarriers, ((CarrierRestrictions)object).allowedCarriers)) {
            return false;
        }
        return HidlSupport.deepEquals(this.excludedCarriers, ((CarrierRestrictions)object).excludedCarriers);
    }

    public final int hashCode() {
        return Objects.hash(HidlSupport.deepHashCode(this.allowedCarriers), HidlSupport.deepHashCode(this.excludedCarriers));
    }

    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        int n;
        int n2 = hwBlob.getInt32(l + 0L + 8L);
        Object object = hwParcel.readEmbeddedBuffer(n2 * 56, hwBlob.handle(), l + 0L + 0L, true);
        this.allowedCarriers.clear();
        for (n = 0; n < n2; ++n) {
            Carrier carrier = new Carrier();
            carrier.readEmbeddedFromParcel(hwParcel, (HwBlob)object, n * 56);
            this.allowedCarriers.add(carrier);
        }
        n2 = hwBlob.getInt32(l + 16L + 8L);
        hwBlob = hwParcel.readEmbeddedBuffer(n2 * 56, hwBlob.handle(), l + 16L + 0L, true);
        this.excludedCarriers.clear();
        for (n = 0; n < n2; ++n) {
            object = new Carrier();
            ((Carrier)object).readEmbeddedFromParcel(hwParcel, hwBlob, n * 56);
            this.excludedCarriers.add((Carrier)object);
        }
    }
