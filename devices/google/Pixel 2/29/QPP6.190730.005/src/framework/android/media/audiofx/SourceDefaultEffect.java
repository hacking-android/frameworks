...
public class SourceDefaultEffect
extends DefaultEffect {
    ...
    public SourceDefaultEffect(UUID uUID, UUID serializable, int n, int n2) {
        int[] arrn = new int[1];
        ...
        if (n != 0) {
            ...
            ((StringBuilder)serializable).append(" when initializing SourceDefaultEffect");
