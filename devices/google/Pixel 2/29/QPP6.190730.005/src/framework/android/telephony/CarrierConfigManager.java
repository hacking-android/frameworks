...
public class CarrierConfigManager {
    ...
    static {
        ...
        sDefaults.putLong(KEY_CARRIER_DATA_CALL_APN_RETRY_AFTER_DISCONNECT_LONG, 10000L);
        sDefaults.putString(KEY_CARRIER_ERI_FILE_NAME_STRING, "eri.xml");
        sDefaults.putInt(KEY_DURATION_BLOCKING_DISABLED_AFTER_EMERGENCY_INT, 7200);
        sDefaults.putStringArray(KEY_CARRIER_METERED_APN_TYPES_STRINGS, new String[]{"default", "mms", "dun", "supl"});
        sDefaults.putStringArray(KEY_CARRIER_METERED_ROAMING_APN_TYPES_STRINGS, new String[]{"default", "mms", "dun", "supl"});
        ...
        charSequence.append(String.valueOf(false));
        charSequence.append(": 7");
        charSequence = charSequence.toString();
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(String.valueOf(true));
        stringBuilder.append(": 8");
        persistableBundle.putStringArray(KEY_CARRIER_DEFAULT_ACTIONS_ON_DEFAULT_NETWORK_AVAILABLE, new String[]{charSequence, stringBuilder.toString()});
        ...
        sDefaults.putIntArray(KEY_LTE_RSRP_THRESHOLDS_INT_ARRAY, new int[]{-128, -118, -108, -98});
        ...
        sDefaults.putLong(KEY_OPPORTUNISTIC_NETWORK_ENTRY_OR_EXIT_HYSTERESIS_TIME_LONG, 10000L);
        sDefaults.putLong(KEY_OPPORTUNISTIC_NETWORK_DATA_SWITCH_HYSTERESIS_TIME_LONG, 10000L);
    ...
    public static boolean isConfigForIdentifiedCarrier(PersistableBundle persistableBundle) {
        boolean bl = persistableBundle != null && persistableBundle.getBoolean(KEY_CARRIER_CONFIG_APPLIED_BOOL);
        return bl;
    }

    public PersistableBundle getConfig() {
        return this.getConfigForSubId(SubscriptionManager.getDefaultSubscriptionId());
    }

    public PersistableBundle getConfigForSubId(int n) {
        Object object;
        block4 : {
            try {
                object = this.getICarrierConfigLoader();
                if (object != null) break block4;
            }
            catch (RemoteException remoteException) {
                object = new StringBuilder();
                ((StringBuilder)object).append("Error getting config for subId ");
                ((StringBuilder)object).append(n);
                ((StringBuilder)object).append(": ");
                ((StringBuilder)object).append(remoteException.toString());
            ...
            ((StringBuilder)object).append("Error getting config for subId ");
            ((StringBuilder)object).append(n);
            ((StringBuilder)object).append(" ICarrierConfigLoader is null");
            Rlog.w(TAG, ((StringBuilder)object).toString());
            return null;
        }
        object = object.getConfigForSubId(n, this.mContext.getOpPackageName());
        return object;
    }

    public String getDefaultCarrierServicePackageName() {
        try {
            String string2 = this.getICarrierConfigLoader().getDefaultCarrierServicePackageName();
            return string2;
        }
     ...
     */
    public void notifyConfigChangedForSubId(int n) {
        try {
            Object object = this.getICarrierConfigLoader();
            if (object == null) {
                object = new StringBuilder();
                ((StringBuilder)object).append("Error reloading config for subId=");
                ((StringBuilder)object).append(n);
                ((StringBuilder)object).append(" ICarrierConfigLoader is null");
                Rlog.w(TAG, ((StringBuilder)object).toString());
                return;
            }
            object.notifyConfigChangedForSubId(n);
            return;
        }
        catch (RemoteException remoteException) {
            StringBuilder stringBuilder = new StringBuilder();
     ...
     */
    @SystemApi
    public void overrideConfig(int n, PersistableBundle object) {
        try {
            ICarrierConfigLoader iCarrierConfigLoader = this.getICarrierConfigLoader();
            if (iCarrierConfigLoader == null) {
                object = new StringBuilder();
                ((StringBuilder)object).append("Error setting config for subId ");
                ((StringBuilder)object).append(n);
                ((StringBuilder)object).append(" ICarrierConfigLoader is null");
                Rlog.w(TAG, ((StringBuilder)object).toString());
                return;
            }
            iCarrierConfigLoader.overrideConfig(n, (PersistableBundle)object);
            return;
        }
        catch (RemoteException remoteException) {
            StringBuilder stringBuilder = new StringBuilder();
     ...
     */
    @SystemApi
    public void updateConfigForPhoneId(int n, String charSequence) {
        try {
            ICarrierConfigLoader iCarrierConfigLoader = this.getICarrierConfigLoader();
            if (iCarrierConfigLoader == null) {
                charSequence = new StringBuilder();
                ((StringBuilder)charSequence).append("Error updating config for phoneId=");
                ((StringBuilder)charSequence).append(n);
                ((StringBuilder)charSequence).append(" ICarrierConfigLoader is null");
                Rlog.w(TAG, ((StringBuilder)charSequence).toString());
                return;
            }
            iCarrierConfigLoader.updateConfigForPhoneId(n, (String)charSequence);
            return;
        }
        catch (RemoteException remoteException) {
            StringBuilder stringBuilder = new StringBuilder();
    ...
    public static final class Gps {
        ...
        private static PersistableBundle getDefaults() {
            ...
            persistableBundle.putString(KEY_LPP_PROFILE_STRING, "0");
    ...
    public static final class Wifi {
        ...
        private static PersistableBundle getDefaults() {
            PersistableBundle persistableBundle = new PersistableBundle();
            persistableBundle.putInt(KEY_CARRIER_PROFILES_VERSION_INT, -1);
            persistableBundle.putString(KEY_CARRIER_CONNECTION_MANAGER_PACKAGE_STRING, null);
            persistableBundle.putStringArray(KEY_NETWORK_PROFILES_STRING_ARRAY, null);
            persistableBundle.putStringArray(KEY_PASSPOINT_PROFILES_STRING_ARRAY, null);
            return persistableBundle;
        }
    }
