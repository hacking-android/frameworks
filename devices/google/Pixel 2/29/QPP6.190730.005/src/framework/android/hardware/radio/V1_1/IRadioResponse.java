...
extends android.hardware.radio.V1_0.IRadioResponse {
    ...
    public void setCarrierInfoForImsiEncryptionResponse(RadioResponseInfo var1) throws RemoteException;

    @Override
    public void setHALInstrumentation() throws RemoteException;

    public void setSimCardPowerResponse_1_1(RadioResponseInfo var1) throws RemoteException;

    public void startKeepaliveResponse(RadioResponseInfo var1, KeepaliveStatus var2) throws RemoteException;

    public void startNetworkScanResponse(RadioResponseInfo var1) throws RemoteException;

    public void stopKeepaliveResponse(RadioResponseInfo var1) throws RemoteException;

    public void stopNetworkScanResponse(RadioResponseInfo var1) throws RemoteException;
    ...
    implements IRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<byte[]>(Arrays.asList({5, -86, 61, -26, 19, 10, -105, -120, -3, -74, -12, -45, -52, 87, -61, -22, -112, -16, 103, -25, 122, 94, 9, -42, -89, 114, -20, 127, 107, -54, 51, -46}, {29, 74, 87, 118, 97, 76, 8, -75, -41, -108, -91, -20, 90, -80, 70, -105, 38, 12, -67, 75, 52, 65, -43, -109, 92, -43, 62, -25, 29, 25, -38, 2}, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioResponse.kInterfaceName, "android.hardware.radio@1.0::IRadioResponse", "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel object, HwParcel object2, int n2) throws RemoteException {
            ...
            block0 : switch (n) {
                ...
                case 122: {
                    ...
                    lceDataInfo.readFromParcel((HwParcel)object);
                    this.pullLceDataResponse((RadioResponseInfo)object2, lceDataInfo);
                    break;
                }
                case 121: {
                    n = n20;
                ...
                case 118: {
                    ...
                    this.getRadioCapabilityResponse(radioResponseInfo, (RadioCapability)object2);
                    break;
                }
                case 117: {
                    n = n24;
                ...
                case 107: {
                    ...
                    object2 = new IccIoResult();
                    ((IccIoResult)object2).readFromParcel((HwParcel)object);
                    this.iccTransmitApduLogicalChannelResponse(radioResponseInfo, (IccIoResult)object2);
                    break;
                }
                case 106: {
                    n = n35;
                ...
                case 103: {
                    ...
                    this.sendImsSmsResponse(radioResponseInfo, (SendSmsResult)object2);
                    break;
                }
                case 102: {
                    n = n39;
                ...
                case 27: {
                    ...
                    RadioResponseInfo radioResponseInfo = new RadioResponseInfo();
                    radioResponseInfo.readFromParcel((HwParcel)object);
                    object2 = new SetupDataCallResult();
                    ((SetupDataCallResult)object2).readFromParcel((HwParcel)object);
                    this.setupDataCallResponse(radioResponseInfo, (SetupDataCallResult)object2);
                    break;
                }
                case 26: {
                    n = n115;
                    ...
                    object2 = new SendSmsResult();
                    ((SendSmsResult)object2).readFromParcel((HwParcel)object);
                    this.sendSMSExpectMoreResponse(radioResponseInfo, (SendSmsResult)object2);
                    break;
                }
                case 25: {
                    n = n116;
                    ...
                    this.sendSmsResponse((RadioResponseInfo)object2, sendSmsResult);
                    break;
                }
                case 24: {
                    n = n117;
                ...
                case 19: {
                    ...
                    RadioResponseInfo radioResponseInfo = new RadioResponseInfo();
                    radioResponseInfo.readFromParcel((HwParcel)object);
                    object2 = new SignalStrength();
                    ((SignalStrength)object2).readFromParcel((HwParcel)object);
                    this.getSignalStrengthResponse(radioResponseInfo, (SignalStrength)object2);
                    break;
                }
                case 18: {
                    n = n123;
                ...
                case 1: {
                    ...
                    this.getIccCardStatusResponse((RadioResponseInfo)object2, cardStatus);
                }
            }
        }
