...
public class ToneGenerator {
    ...
    public ToneGenerator(int n, int n2) {
        this.native_setup(n, n2);
    }

    private final native void native_finalize();

    private final native void native_setup(int var1, int var2);
    ...
    public boolean startTone(int n) {
        return this.startTone(n, -1);
    }

    public native boolean startTone(int var1, int var2);
