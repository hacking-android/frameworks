...
public class GLES31Ext {
    ...
    public static native void glBlendEquationSeparateiEXT(int var0, int var1, int var2);

    public static native void glBlendEquationiEXT(int var0, int var1);

    public static native void glBlendFuncSeparateiEXT(int var0, int var1, int var2, int var3, int var4);

    public static native void glBlendFunciEXT(int var0, int var1, int var2);

    public static native void glColorMaskiEXT(int var0, boolean var1, boolean var2, boolean var3, boolean var4);

    public static native void glCopyImageSubDataEXT(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14);

    public static native void glDebugMessageCallbackKHR(DebugProcKHR var0);

    public static native void glDebugMessageControlKHR(int var0, int var1, int var2, int var3, IntBuffer var4, boolean var5);

    public static native void glDebugMessageControlKHR(int var0, int var1, int var2, int var3, int[] var4, int var5, boolean var6);

    public static native void glDebugMessageInsertKHR(int var0, int var1, int var2, int var3, String var4);

    public static native void glDisableiEXT(int var0, int var1);

    public static native void glEnableiEXT(int var0, int var1);

    public static native void glFramebufferTextureEXT(int var0, int var1, int var2, int var3);

    public static native DebugProcKHR glGetDebugMessageCallbackKHR();

    public static native int glGetDebugMessageLogKHR(int var0, int var1, int[] var2, int var3, int[] var4, int var5, int[] var6, int var7, int[] var8, int var9, int[] var10, int var11, byte[] var12, int var13);

    public static native int glGetDebugMessageLogKHR(int var0, IntBuffer var1, IntBuffer var2, IntBuffer var3, IntBuffer var4, IntBuffer var5, ByteBuffer var6);

    public static native String[] glGetDebugMessageLogKHR(int var0, IntBuffer var1, IntBuffer var2, IntBuffer var3, IntBuffer var4);

    public static native String[] glGetDebugMessageLogKHR(int var0, int[] var1, int var2, int[] var3, int var4, int[] var5, int var6, int[] var7, int var8);

    public static native String glGetObjectLabelKHR(int var0, int var1);

    public static native String glGetObjectPtrLabelKHR(long var0);

    public static native void glGetSamplerParameterIivEXT(int var0, int var1, IntBuffer var2);

    public static native void glGetSamplerParameterIivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glGetSamplerParameterIuivEXT(int var0, int var1, IntBuffer var2);

    public static native void glGetSamplerParameterIuivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glGetTexParameterIivEXT(int var0, int var1, IntBuffer var2);

    public static native void glGetTexParameterIivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glGetTexParameterIuivEXT(int var0, int var1, IntBuffer var2);

    public static native void glGetTexParameterIuivEXT(int var0, int var1, int[] var2, int var3);

    public static native boolean glIsEnablediEXT(int var0, int var1);

    public static native void glMinSampleShadingOES(float var0);

    public static native void glObjectLabelKHR(int var0, int var1, int var2, String var3);

    public static native void glObjectPtrLabelKHR(long var0, String var2);

    public static native void glPatchParameteriEXT(int var0, int var1);

    public static native void glPopDebugGroupKHR();

    public static native void glPrimitiveBoundingBoxEXT(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7);

    public static native void glPushDebugGroupKHR(int var0, int var1, int var2, String var3);

    public static native void glSamplerParameterIivEXT(int var0, int var1, IntBuffer var2);

    public static native void glSamplerParameterIivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glSamplerParameterIuivEXT(int var0, int var1, IntBuffer var2);

    public static native void glSamplerParameterIuivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glTexBufferEXT(int var0, int var1, int var2);

    public static native void glTexBufferRangeEXT(int var0, int var1, int var2, int var3, int var4);

    public static native void glTexParameterIivEXT(int var0, int var1, IntBuffer var2);

    public static native void glTexParameterIivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glTexParameterIuivEXT(int var0, int var1, IntBuffer var2);

    public static native void glTexParameterIuivEXT(int var0, int var1, int[] var2, int var3);

    public static native void glTexStorage3DMultisampleOES(int var0, int var1, int var2, int var3, int var4, int var5, boolean var6);
