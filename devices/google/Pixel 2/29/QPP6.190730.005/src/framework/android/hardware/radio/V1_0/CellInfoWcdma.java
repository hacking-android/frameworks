...
public final class CellInfoWcdma {
    ...
    public static final ArrayList<CellInfoWcdma> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            ((CellInfoWcdma)object).readEmbeddedFromParcel(hwParcel, hwBlob, i * 56);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        ...
        this.signalStrengthWcdma.readEmbeddedFromParcel(hwParcel, hwBlob, 48L + l);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long l) {
        ...
        this.signalStrengthWcdma.writeEmbeddedToBlob(hwBlob, 48L + l);
    }
