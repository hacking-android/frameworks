...
public final class CellConfigLte {
    ...
    public static final ArrayList<CellConfigLte> readVectorFromParcel(HwParcel hwParcel) {
        ArrayList<CellConfigLte> arrayList = new ArrayList<CellConfigLte>();
        Object object = hwParcel.readBuffer(16L);
        int n = ((HwBlob)object).getInt32(8L);
        HwBlob hwBlob = hwParcel.readEmbeddedBuffer(n * 1, ((HwBlob)object).handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < n; ++i) {
            object = new CellConfigLte();
            ((CellConfigLte)object).readEmbeddedFromParcel(hwParcel, hwBlob, i * 1);
            arrayList.add((CellConfigLte)object);
        }
        return arrayList;
    }
    ...
    public final boolean equals(Object object) {
        ...
        if (object.getClass() != CellConfigLte.class) {
            return false;
        }
        object = (CellConfigLte)object;
        return this.isEndcAvailable == ((CellConfigLte)object).isEndcAvailable;
    }

    public final int hashCode() {
        return Objects.hash(HidlSupport.deepHashCode(this.isEndcAvailable));
    }
