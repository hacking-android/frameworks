...
extends IInterface {
    public void onVrStateChanged(boolean var1) throws RemoteException;
    ...
    implements IVrStateCallbacks {
        ...
        @Override
        public void onVrStateChanged(boolean bl) throws RemoteException {
        }
    }
    ...
    implements IVrStateCallbacks {
        ...
        public static boolean setDefaultImpl(IVrStateCallbacks iVrStateCallbacks) {
            if (Proxy.sDefaultImpl == null && iVrStateCallbacks != null) {
                Proxy.sDefaultImpl = iVrStateCallbacks;
                return true;
            }
            return false;
        }
            ...
            public void onVrStateChanged(boolean bl) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, parcel, null, 1) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onVrStateChanged(bl);
                        return;
                    }
                    return;
                }
