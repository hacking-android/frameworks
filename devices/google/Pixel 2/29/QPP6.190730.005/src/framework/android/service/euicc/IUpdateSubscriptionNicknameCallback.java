...
extends IInterface {
    ...
    implements IUpdateSubscriptionNicknameCallback {
        ...
        public static boolean setDefaultImpl(IUpdateSubscriptionNicknameCallback iUpdateSubscriptionNicknameCallback) {
            if (Proxy.sDefaultImpl == null && iUpdateSubscriptionNicknameCallback != null) {
                Proxy.sDefaultImpl = iUpdateSubscriptionNicknameCallback;
                return true;
            }
            return false;
        }
