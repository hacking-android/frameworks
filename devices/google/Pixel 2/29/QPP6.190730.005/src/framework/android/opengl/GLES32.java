...
extends GLES31 {
    ...
    public static native void glBlendEquationSeparatei(int var0, int var1, int var2);

    public static native void glBlendEquationi(int var0, int var1);

    public static native void glBlendFuncSeparatei(int var0, int var1, int var2, int var3, int var4);

    public static native void glBlendFunci(int var0, int var1, int var2);

    public static native void glColorMaski(int var0, boolean var1, boolean var2, boolean var3, boolean var4);

    public static native void glCopyImageSubData(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14);

    public static native void glDebugMessageCallback(DebugProc var0);

    public static native void glDebugMessageControl(int var0, int var1, int var2, int var3, IntBuffer var4, boolean var5);

    public static native void glDebugMessageControl(int var0, int var1, int var2, int var3, int[] var4, int var5, boolean var6);

    public static native void glDebugMessageInsert(int var0, int var1, int var2, int var3, int var4, String var5);

    public static native void glDisablei(int var0, int var1);

    public static native void glDrawElementsBaseVertex(int var0, int var1, int var2, Buffer var3, int var4);

    public static native void glDrawElementsInstancedBaseVertex(int var0, int var1, int var2, int var3, int var4, int var5);

    public static native void glDrawElementsInstancedBaseVertex(int var0, int var1, int var2, Buffer var3, int var4, int var5);

    public static native void glDrawRangeElementsBaseVertex(int var0, int var1, int var2, int var3, int var4, Buffer var5, int var6);

    public static native void glEnablei(int var0, int var1);

    public static native void glFramebufferTexture(int var0, int var1, int var2, int var3);

    public static native int glGetDebugMessageLog(int var0, int var1, int[] var2, int var3, int[] var4, int var5, int[] var6, int var7, int[] var8, int var9, int[] var10, int var11, byte[] var12, int var13);

    public static native int glGetDebugMessageLog(int var0, IntBuffer var1, IntBuffer var2, IntBuffer var3, IntBuffer var4, IntBuffer var5, ByteBuffer var6);

    public static native String[] glGetDebugMessageLog(int var0, IntBuffer var1, IntBuffer var2, IntBuffer var3, IntBuffer var4);

    public static native String[] glGetDebugMessageLog(int var0, int[] var1, int var2, int[] var3, int var4, int[] var5, int var6, int[] var7, int var8);

    public static native int glGetGraphicsResetStatus();

    public static native String glGetObjectLabel(int var0, int var1);

    public static native String glGetObjectPtrLabel(long var0);

    public static native long glGetPointerv(int var0);

    public static native void glGetSamplerParameterIiv(int var0, int var1, IntBuffer var2);

    public static native void glGetSamplerParameterIiv(int var0, int var1, int[] var2, int var3);

    public static native void glGetSamplerParameterIuiv(int var0, int var1, IntBuffer var2);

    public static native void glGetSamplerParameterIuiv(int var0, int var1, int[] var2, int var3);

    public static native void glGetTexParameterIiv(int var0, int var1, IntBuffer var2);

    public static native void glGetTexParameterIiv(int var0, int var1, int[] var2, int var3);

    public static native void glGetTexParameterIuiv(int var0, int var1, IntBuffer var2);

    public static native void glGetTexParameterIuiv(int var0, int var1, int[] var2, int var3);

    public static native void glGetnUniformfv(int var0, int var1, int var2, FloatBuffer var3);

    public static native void glGetnUniformfv(int var0, int var1, int var2, float[] var3, int var4);

    public static native void glGetnUniformiv(int var0, int var1, int var2, IntBuffer var3);

    public static native void glGetnUniformiv(int var0, int var1, int var2, int[] var3, int var4);

    public static native void glGetnUniformuiv(int var0, int var1, int var2, IntBuffer var3);

    public static native void glGetnUniformuiv(int var0, int var1, int var2, int[] var3, int var4);

    public static native boolean glIsEnabledi(int var0, int var1);

    public static native void glMinSampleShading(float var0);

    public static native void glObjectLabel(int var0, int var1, int var2, String var3);

    public static native void glObjectPtrLabel(long var0, String var2);

    public static native void glPatchParameteri(int var0, int var1);

    public static native void glPopDebugGroup();

    public static native void glPrimitiveBoundingBox(float var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7);

    public static native void glPushDebugGroup(int var0, int var1, int var2, String var3);

    public static native void glReadnPixels(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Buffer var7);

    public static native void glSamplerParameterIiv(int var0, int var1, IntBuffer var2);

    public static native void glSamplerParameterIiv(int var0, int var1, int[] var2, int var3);

    public static native void glSamplerParameterIuiv(int var0, int var1, IntBuffer var2);

    public static native void glSamplerParameterIuiv(int var0, int var1, int[] var2, int var3);

    public static native void glTexBuffer(int var0, int var1, int var2);

    public static native void glTexBufferRange(int var0, int var1, int var2, int var3, int var4);

    public static native void glTexParameterIiv(int var0, int var1, IntBuffer var2);

    public static native void glTexParameterIiv(int var0, int var1, int[] var2, int var3);

    public static native void glTexParameterIuiv(int var0, int var1, IntBuffer var2);

    public static native void glTexParameterIuiv(int var0, int var1, int[] var2, int var3);

    public static native void glTexStorage3DMultisample(int var0, int var1, int var2, int var3, int var4, int var5, boolean var6);
