...
public final class NetworkScanResult {
    ...
    public static final ArrayList<NetworkScanResult> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            ((NetworkScanResult)object).readEmbeddedFromParcel(hwParcel, hwBlob, i * 24);
            arrayList.add((NetworkScanResult)object);
        }
        return arrayList;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        ...
        this.error = hwBlob.getInt32(l + 4L);
        int n = hwBlob.getInt32(l + 8L + 8L);
        hwBlob = hwParcel.readEmbeddedBuffer(n * 112, hwBlob.handle(), l + 8L + 0L, true);
