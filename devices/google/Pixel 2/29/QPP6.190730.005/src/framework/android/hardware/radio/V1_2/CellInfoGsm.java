...
public final class CellInfoGsm {
    ...
    public static final ArrayList<CellInfoGsm> readVectorFromParcel(HwParcel hwParcel) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            cellInfoGsm.readEmbeddedFromParcel(hwParcel, hwBlob, i * 96);
    ...
    public final void readEmbeddedFromParcel(HwParcel hwParcel, HwBlob hwBlob, long l) {
        ...
        this.signalStrengthGsm.readEmbeddedFromParcel(hwParcel, hwBlob, 80L + l);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long l) {
        ...
        this.signalStrengthGsm.writeEmbeddedToBlob(hwBlob, 80L + l);
    }
