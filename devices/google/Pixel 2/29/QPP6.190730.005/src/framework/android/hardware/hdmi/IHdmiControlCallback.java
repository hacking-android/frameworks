...
extends IInterface {
    ...
    implements IHdmiControlCallback {
        ...
        public static boolean setDefaultImpl(IHdmiControlCallback iHdmiControlCallback) {
            if (Proxy.sDefaultImpl == null && iHdmiControlCallback != null) {
                Proxy.sDefaultImpl = iHdmiControlCallback;
                return true;
            }
            return false;
        }
