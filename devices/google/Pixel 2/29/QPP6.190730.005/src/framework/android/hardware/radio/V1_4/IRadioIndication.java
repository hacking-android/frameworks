...
import android.hardware.radio.V1_4.NetworkScanResult;
...
extends android.hardware.radio.V1_3.IRadioIndication {
    ...
    public void cellInfoList_1_4(int var1, ArrayList<CellInfo> var2) throws RemoteException;

    public void currentEmergencyNumberList(int var1, ArrayList<EmergencyNumber> var2) throws RemoteException;

    public void currentPhysicalChannelConfigs_1_4(int var1, ArrayList<PhysicalChannelConfig> var2) throws RemoteException;

    public void currentSignalStrength_1_4(int var1, SignalStrength var2) throws RemoteException;

    public void dataCallListChanged_1_4(int var1, ArrayList<SetupDataCallResult> var2) throws RemoteException;
    ...
    public void networkScanResult_1_4(int var1, NetworkScanResult var2) throws RemoteException;
    ...
    implements IRadioIndication {
        ...
        @Override
        public void cellInfoList(int n, ArrayList<android.hardware.radio.V1_0.CellInfo> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio@1.0::IRadioIndication");
            hwParcel.writeInt32(n);
            android.hardware.radio.V1_0.CellInfo.writeVectorToParcel(hwParcel, object);
            object = new HwParcel();
            try {
        ...
        @Override
        public void cellInfoList_1_4(int n, ArrayList<CellInfo> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
        ...
        @Override
        public void currentEmergencyNumberList(int n, ArrayList<EmergencyNumber> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(n);
            EmergencyNumber.writeVectorToParcel(hwParcel, object);
            object = new HwParcel();
            try {
        ...
        @Override
        public void currentPhysicalChannelConfigs(int n, ArrayList<android.hardware.radio.V1_2.PhysicalChannelConfig> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
            hwParcel.writeInt32(n);
            android.hardware.radio.V1_2.PhysicalChannelConfig.writeVectorToParcel(hwParcel, object);
            object = new HwParcel();
            try {
        ...
        @Override
        public void currentPhysicalChannelConfigs_1_4(int n, ArrayList<PhysicalChannelConfig> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(n);
        ...
        @Override
        public void currentSignalStrength_1_2(int n, android.hardware.radio.V1_2.SignalStrength object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio@1.2::IRadioIndication");
            hwParcel.writeInt32(n);
            ((android.hardware.radio.V1_2.SignalStrength)object).writeToParcel(hwParcel);
            object = new HwParcel();
            try {
        ...
        @Override
        public void currentSignalStrength_1_4(int n, SignalStrength object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(n);
        ...
        @Override
        public void dataCallListChanged(int n, ArrayList<android.hardware.radio.V1_0.SetupDataCallResult> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio@1.0::IRadioIndication");
            hwParcel.writeInt32(n);
            android.hardware.radio.V1_0.SetupDataCallResult.writeVectorToParcel(hwParcel, object);
            object = new HwParcel();
            try {
        ...
        @Override
        public void dataCallListChanged_1_4(int n, ArrayList<SetupDataCallResult> object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(n);
        ...
        @Override
        public void networkScanResult(int n, android.hardware.radio.V1_1.NetworkScanResult object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio@1.1::IRadioIndication");
            hwParcel.writeInt32(n);
            ((android.hardware.radio.V1_1.NetworkScanResult)object).writeToParcel(hwParcel);
            object = new HwParcel();
            try {
        ...
        @Override
        public void networkScanResult_1_4(int n, NetworkScanResult object) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken(IRadioIndication.kInterfaceName);
            hwParcel.writeInt32(n);
    ...
    implements IRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            byte[] arrby = new byte[]{92, -114, -5, -71, -60, 81, -91, -105, 55, -19, 44, 108, 32, 35, 10, -82, 71, 69, -125, -100, -96, 29, -128, -120, -42, -36, -55, 2, 14, 82, -46, -59};
            return new ArrayList<byte[]>(Arrays.asList({51, -39, -26, -119, 92, -54, -104, -86, 86, 41, 107, -80, 23, 32, -47, -117, -118, -51, 14, 77, -28, -106, 11, -21, 113, 46, 99, -83, 20, 116, 56, -91}, {-23, -48, -15, 26, 82, 113, 95, 90, 41, -40, -98, 45, -114, 46, 33, -37, 30, 22, -92, 49, 116, -81, 107, -99, 81, -90, 45, 112, 92, -38, 20, 85}, {-51, -89, 82, -82, -85, -86, -68, 32, 72, 106, -126, -84, 87, -93, -35, 16, 119, -123, -64, 6, 9, 74, 52, -101, -59, -30, 36, -24, -86, 34, -95, 124}, {-4, -59, -56, -56, -117, -123, -87, -10, 63, -70, 103, -39, -26, 116, -38, 70, 108, 114, -87, -116, -94, -121, -13, 67, -5, 87, 33, -48, -104, 113, 63, -122}, arrby, {-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }

        @Override
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<String>(Arrays.asList(IRadioIndication.kInterfaceName, "android.hardware.radio@1.3::IRadioIndication", "android.hardware.radio@1.2::IRadioIndication", "android.hardware.radio@1.1::IRadioIndication", "android.hardware.radio@1.0::IRadioIndication", "android.hidl.base@1.0::IBase"));
        }
        ...
        public void onTransact(int n, HwParcel arrby, HwParcel object, int n2) throws RemoteException {
            ...
            block0 : switch (n) {
                ...
                case 59: {
                    ...
                    arrby.enforceInterface(IRadioIndication.kInterfaceName);
                    n = arrby.readInt32();
                    object = new SignalStrength();
                    ((SignalStrength)object).readFromParcel((HwParcel)arrby);
                    this.currentSignalStrength_1_4(n, (SignalStrength)object);
                    break;
                }
                case 58: {
                    n = n7;
                    ...
                    arrby.enforceInterface(IRadioIndication.kInterfaceName);
                    this.dataCallListChanged_1_4(arrby.readInt32(), SetupDataCallResult.readVectorFromParcel(arrby));
                    break;
                }
                case 57: {
                    n = n8;
                    ...
                    arrby.enforceInterface(IRadioIndication.kInterfaceName);
                    this.currentPhysicalChannelConfigs_1_4(arrby.readInt32(), PhysicalChannelConfig.readVectorFromParcel(arrby));
                    break;
                }
                case 56: {
                    n = n9;
                    ...
                    this.networkScanResult_1_4(n, (NetworkScanResult)object);
                    break;
                }
                case 55: {
                    n = n10;
                    ...
                    arrby.enforceInterface(IRadioIndication.kInterfaceName);
                    this.cellInfoList_1_4(arrby.readInt32(), CellInfo.readVectorFromParcel(arrby));
                    break;
                }
                case 54: {
                    n = n11;
                    ...
                    arrby.enforceInterface(IRadioIndication.kInterfaceName);
                    this.currentEmergencyNumberList(arrby.readInt32(), EmergencyNumber.readVectorFromParcel(arrby));
                    break;
                }
                case 53: {
                    n = n12;
                    ...
                    this.currentSignalStrength_1_2(n, (android.hardware.radio.V1_2.SignalStrength)object);
                    break;
                }
                case 52: {
                    n = n13;
                    ...
                    arrby.enforceInterface("android.hardware.radio@1.2::IRadioIndication");
                    this.currentPhysicalChannelConfigs(arrby.readInt32(), android.hardware.radio.V1_2.PhysicalChannelConfig.readVectorFromParcel(arrby));
                    break;
                }
                case 51: {
                    n = n14;
                ...
                case 47: {
                    ...
                    arrby.enforceInterface("android.hardware.radio@1.1::IRadioIndication");
                    n = arrby.readInt32();
                    object = new android.hardware.radio.V1_1.NetworkScanResult();
                    ((android.hardware.radio.V1_1.NetworkScanResult)object).readFromParcel((HwParcel)arrby);
                    this.networkScanResult(n, (android.hardware.radio.V1_1.NetworkScanResult)object);
                    break;
                }
                case 46: {
                    n = n19;
                ...
                case 35: {
                    ...
                    arrby.enforceInterface("android.hardware.radio@1.0::IRadioIndication");
                    this.cellInfoList(arrby.readInt32(), android.hardware.radio.V1_0.CellInfo.readVectorFromParcel(arrby));
                    break;
                }
                case 34: {
                    n = n31;
                ...
                case 10: {
                    ...
                    arrby.enforceInterface("android.hardware.radio@1.0::IRadioIndication");
                    this.dataCallListChanged(arrby.readInt32(), android.hardware.radio.V1_0.SetupDataCallResult.readVectorFromParcel(arrby));
                    break;
                }
                case 9: {
                    n = n56;
