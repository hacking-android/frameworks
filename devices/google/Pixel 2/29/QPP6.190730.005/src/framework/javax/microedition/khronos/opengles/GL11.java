...
extends GL10 {
    ...
    public void glClipPlanef(int var1, FloatBuffer var2);

    public void glClipPlanef(int var1, float[] var2, int var3);

    public void glClipPlanex(int var1, IntBuffer var2);

    public void glClipPlanex(int var1, int[] var2, int var3);

    public void glColor4ub(byte var1, byte var2, byte var3, byte var4);

    public void glColorPointer(int var1, int var2, int var3, int var4);
    ...
    public void glGetBooleanv(int var1, IntBuffer var2);

    public void glGetBooleanv(int var1, boolean[] var2, int var3);
    ...
    public void glGetClipPlanef(int var1, FloatBuffer var2);

    public void glGetClipPlanef(int var1, float[] var2, int var3);

    public void glGetClipPlanex(int var1, IntBuffer var2);

    public void glGetClipPlanex(int var1, int[] var2, int var3);

    public void glGetFixedv(int var1, IntBuffer var2);

    public void glGetFixedv(int var1, int[] var2, int var3);
    ...
    public void glGetLightxv(int var1, int var2, IntBuffer var3);

    public void glGetLightxv(int var1, int var2, int[] var3, int var4);
    ...
    public void glGetMaterialxv(int var1, int var2, IntBuffer var3);

    public void glGetMaterialxv(int var1, int var2, int[] var3, int var4);

    public void glGetPointerv(int var1, Buffer[] var2);

    public void glGetTexEnviv(int var1, int var2, IntBuffer var3);

    public void glGetTexEnviv(int var1, int var2, int[] var3, int var4);

    public void glGetTexEnvxv(int var1, int var2, IntBuffer var3);

    public void glGetTexEnvxv(int var1, int var2, int[] var3, int var4);
    ...
    public void glGetTexParameterxv(int var1, int var2, IntBuffer var3);

    public void glGetTexParameterxv(int var1, int var2, int[] var3, int var4);
    ...
    public void glNormalPointer(int var1, int var2, int var3);
    ...
    public void glPointParameterx(int var1, int var2);

    public void glPointParameterxv(int var1, IntBuffer var2);

    public void glPointParameterxv(int var1, int[] var2, int var3);

    public void glPointSizePointerOES(int var1, int var2, Buffer var3);

    public void glTexCoordPointer(int var1, int var2, int var3, int var4);
    ...
    public void glTexParameterxv(int var1, int var2, IntBuffer var3);

    public void glTexParameterxv(int var1, int var2, int[] var3, int var4);

    public void glVertexPointer(int var1, int var2, int var3, int var4);
}
