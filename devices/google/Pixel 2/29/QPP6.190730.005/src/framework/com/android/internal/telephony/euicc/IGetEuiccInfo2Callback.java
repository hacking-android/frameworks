...
public interface IGetEuiccInfo2Callback
extends IInterface {
    ...
    implements IGetEuiccInfo2Callback {
        ...
        public static IGetEuiccInfo2Callback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof IGetEuiccInfo2Callback) {
                return (IGetEuiccInfo2Callback)iInterface;
            }
        ...
        public static boolean setDefaultImpl(IGetEuiccInfo2Callback iGetEuiccInfo2Callback) {
            if (Proxy.sDefaultImpl == null && iGetEuiccInfo2Callback != null) {
                Proxy.sDefaultImpl = iGetEuiccInfo2Callback;
                return true;
            }
            return false;
        }
