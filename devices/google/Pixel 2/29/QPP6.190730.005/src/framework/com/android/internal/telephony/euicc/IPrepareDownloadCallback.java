...
extends IInterface {
    ...
    implements IPrepareDownloadCallback {
        ...
        public static boolean setDefaultImpl(IPrepareDownloadCallback iPrepareDownloadCallback) {
            if (Proxy.sDefaultImpl == null && iPrepareDownloadCallback != null) {
                Proxy.sDefaultImpl = iPrepareDownloadCallback;
                return true;
            }
            return false;
        }
