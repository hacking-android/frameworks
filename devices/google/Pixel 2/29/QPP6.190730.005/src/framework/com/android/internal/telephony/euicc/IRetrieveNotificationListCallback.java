...
public interface IRetrieveNotificationListCallback
extends IInterface {
    ...
    implements IRetrieveNotificationListCallback {
        ...
        public static IRetrieveNotificationListCallback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof IRetrieveNotificationListCallback) {
                return (IRetrieveNotificationListCallback)iInterface;
            }
        ...
        public static boolean setDefaultImpl(IRetrieveNotificationListCallback iRetrieveNotificationListCallback) {
            if (Proxy.sDefaultImpl == null && iRetrieveNotificationListCallback != null) {
                Proxy.sDefaultImpl = iRetrieveNotificationListCallback;
                return true;
            }
            return false;
        }
