...
public interface IResetMemoryCallback
extends IInterface {
    ...
    implements IResetMemoryCallback {
        ...
        public static IResetMemoryCallback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof IResetMemoryCallback) {
                return (IResetMemoryCallback)iInterface;
            }
        ...
        public static boolean setDefaultImpl(IResetMemoryCallback iResetMemoryCallback) {
            if (Proxy.sDefaultImpl == null && iResetMemoryCallback != null) {
                Proxy.sDefaultImpl = iResetMemoryCallback;
                return true;
            }
            return false;
        }
