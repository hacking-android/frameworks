...
extends IInterface {
    ...
    implements IVoiceInteractorRequest {
        ...
        public static boolean setDefaultImpl(IVoiceInteractorRequest iVoiceInteractorRequest) {
            if (Proxy.sDefaultImpl == null && iVoiceInteractorRequest != null) {
                Proxy.sDefaultImpl = iVoiceInteractorRequest;
                return true;
            }
            return false;
        }
