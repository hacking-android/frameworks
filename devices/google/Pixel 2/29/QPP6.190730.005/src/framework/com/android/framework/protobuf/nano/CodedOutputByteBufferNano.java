...
public final class CodedOutputByteBufferNano {
    ...
    public static int computeStringSize(int n, String string2) {
        return CodedOutputByteBufferNano.computeTagSize(n) + CodedOutputByteBufferNano.computeStringSizeNoTag(string2);
    }

    public static int computeStringSizeNoTag(String string2) {
        int n = CodedOutputByteBufferNano.encodedLength(string2);
        return CodedOutputByteBufferNano.computeRawVarint32Size(n) + n;
    }
    ...
    private static int encodedLength(CharSequence charSequence) {
        ...
        block3 : {
            ...
            n = n4 + CodedOutputByteBufferNano.encodedLengthGeneral(charSequence, n3);
        }
        if (n >= n2) {
            return n;
        }
