...
public interface ISetNicknameCallback
extends IInterface {
    ...
    implements ISetNicknameCallback {
        ...
        public static ISetNicknameCallback asInterface(IBinder iBinder) {
            ...
            if (iInterface != null && iInterface instanceof ISetNicknameCallback) {
                return (ISetNicknameCallback)iInterface;
            }
        ...
        public static boolean setDefaultImpl(ISetNicknameCallback iSetNicknameCallback) {
            if (Proxy.sDefaultImpl == null && iSetNicknameCallback != null) {
                Proxy.sDefaultImpl = iSetNicknameCallback;
                return true;
            }
            return false;
        }
