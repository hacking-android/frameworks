...
public interface IRemoveNotificationFromListCallback
extends IInterface {
    ...
    implements IRemoveNotificationFromListCallback {
        ...
        public static boolean setDefaultImpl(IRemoveNotificationFromListCallback iRemoveNotificationFromListCallback) {
            if (Proxy.sDefaultImpl == null && iRemoveNotificationFromListCallback != null) {
                Proxy.sDefaultImpl = iRemoveNotificationFromListCallback;
                return true;
            }
            return false;
        }
