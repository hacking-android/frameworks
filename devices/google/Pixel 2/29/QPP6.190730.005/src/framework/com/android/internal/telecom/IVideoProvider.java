...
extends IInterface {
    public void addVideoCallback(IBinder var1) throws RemoteException;

    public void removeVideoCallback(IBinder var1) throws RemoteException;
    ...
    public void setCamera(String var1, String var2, int var3) throws RemoteException;
    ...
    implements IVideoProvider {
        ...
        @Override
        public void setCamera(String string2, String string3, int n) throws RemoteException {
        }
    ...
    implements IVideoProvider {
        ...
        public static boolean setDefaultImpl(IVideoProvider iVideoProvider) {
            if (Proxy.sDefaultImpl == null && iVideoProvider != null) {
                Proxy.sDefaultImpl = iVideoProvider;
                return true;
            }
            return false;
        }
        ...
        public boolean onTransact(int n, Parcel object, Parcel object2, int n2) throws RemoteException {
            if (n != 1598968902) {
                switch (n) {
                    ...
                    case 3: {
                        ((Parcel)object).enforceInterface(DESCRIPTOR);
                        this.setCamera(((Parcel)object).readString(), ((Parcel)object).readString(), ((Parcel)object).readInt());
                        return true;
                    }
                    case 2: {
                        ((Parcel)object).enforceInterface(DESCRIPTOR);
                        this.removeVideoCallback(((Parcel)object).readStrongBinder());
                        return true;
                    }
                    case 1: 
                }
                ((Parcel)object).enforceInterface(DESCRIPTOR);
                this.addVideoCallback(((Parcel)object).readStrongBinder());
                return true;
            }
            ...
            public void addVideoCallback(IBinder iBinder) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(1, parcel, null, 1) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().addVideoCallback(iBinder);
                        return;
                    }
                    return;
                }
            ...
            public void removeVideoCallback(IBinder iBinder) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, parcel, null, 1) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().removeVideoCallback(iBinder);
                        return;
                    }
                    return;
                }
            ...
            public void setCamera(String string2, String string3, int n) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(3, parcel, null, 1) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().setCamera(string2, string3, n);
                        return;
                    }
                    return;
                }
