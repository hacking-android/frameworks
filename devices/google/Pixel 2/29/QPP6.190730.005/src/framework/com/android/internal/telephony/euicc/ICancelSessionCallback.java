...
public interface ICancelSessionCallback
extends IInterface {
    ...
    implements ICancelSessionCallback {
        ...
        public static boolean setDefaultImpl(ICancelSessionCallback iCancelSessionCallback) {
            if (Proxy.sDefaultImpl == null && iCancelSessionCallback != null) {
                Proxy.sDefaultImpl = iCancelSessionCallback;
                return true;
            }
            return false;
        }
