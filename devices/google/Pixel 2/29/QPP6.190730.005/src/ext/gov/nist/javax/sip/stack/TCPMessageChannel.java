...
RawMessageChannel {
    ...
    private void sendMessage(byte[] object, boolean bl) throws IOException {
        Socket socket;
        object = this.sipStack.ioHandler.sendBytes(this.messageProcessor.getIpAddress(), this.peerAddress, this.peerPort, this.peerProtocol, (byte[])object, bl, this);
        if (object != (socket = this.mySock) && object != null) {
            ...
            ((Thread)object).setName("TCPMessageChannelThread");
            ((Thread)object).start();
        }
    }
    ...
    public boolean equals(Object object) {
        ...
        object = (TCPMessageChannel)object;
        return this.mySock == ((TCPMessageChannel)object).mySock;
    }
    ...
    public void handleException(ParseException parseException, SIPMessage object, Class object2, String charSequence, String string) throws ParseException {
        ...
        if (object2 != null && (object2.equals(From.class) || object2.equals(To.class) || object2.equals(CSeq.class) || object2.equals(Via.class) || object2.equals(CallID.class) || object2.equals(RequestLine.class) || object2.equals(StatusLine.class))) {
            if (this.sipStack.isLoggingEnabled()) {
                ...
                ((StringBuilder)charSequence).append(((SIPMessage)object).toString());
    ...
    public void processMessage(SIPMessage object) throws Exception {
            ...
            block28 : {
                ...
                if (object instanceof SIPRequest) {
                    ...
                    try {
                        ...
                        InternalErrorHandler.handleException(parseException, this.sipStack.getStackLogger());
                    }
                    if (!this.isCached) {
                        ((TCPMessageProcessor)this.messageProcessor).cacheMessageChannel(this);
                        this.isCached = true;
                        n = ((InetSocketAddress)this.mySock.getRemoteSocketAddress()).getPort();
                        object3 = IOHandler.makeKey(this.mySock.getInetAddress(), n);
                ...
                if (bl) {
                    ...
                    if (this.sipStack.getStackLogger().isLoggingEnabled(16)) {
                        ...
                        ((StringBuilder)object2).append(this.getMessageProcessor().getIpAddress().getHostAddress());
                        ((StringBuilder)object2).append(":");
                        ((StringBuilder)object2).append(this.getMessageProcessor().getPort());
                        serverLogger.logMessage((SIPMessage)object, string, ((StringBuilder)object2).toString(), false, l);
                    }
                ...
                try {
                    ...
                    if (this.sipStack.getMaxMessageSize() <= 0) break block28;
                }
                catch (ParseException parseException) {
                    if (!this.sipStack.isLoggingEnabled()) return;
                    object2 = this.sipStack.getStackLogger();
        ...
        object = ((SIPMessage)object).encode();
        if (!this.sipStack.isLoggingEnabled()) return;
    ...
    public void run() {
        block27 : {
            ...
            var2_5 /* !! */  = this.tcpMessageProcessor;
            ++var2_5 /* !! */ .useCount;
            this.isRunning = true;
            do {
                try {
                    do {
                        block24 : {
                            var2_5 /* !! */  = new byte[4096];
                            var3_10 = this.myClientInputStream.read(var2_5 /* !! */ , 0, 4096);
                            ...
                            try {
                                ...
                                var2_5 /* !! */  = this.tcpMessageProcessor;
                                // MONITORENTER : var2_5 /* !! */ 
                                var4_11 = this.tcpMessageProcessor;
...
lbl-1000: // 2 sources:
                            ...
                            var1_1 = this.tcpMessageProcessor;
                            --var1_1.useCount;
                            this.myParser.close();
                            return;
                        }
                        var1_1.write(var2_5 /* !! */ , 0, var3_10);
                        continue;
                        break;
                    } while (true);
                }
                    ...
                    ** GOTO lbl73
                    ...
                    InternalErrorHandler.handleException(var2_7, this.sipStack.getStackLogger());
                    continue;
                }
                break;
            } while (true);
                ...
                try {
                    block26 : {
                        ...
                        try {
                            ...
                            var2_9 = this.tcpMessageProcessor;
                            // MONITORENTER : var2_9
                            var4_13 = this.tcpMessageProcessor;
...
lbl73: // 1 sources:
    ...
    public void sendMessage(byte[] object, InetAddress object2, int n, boolean bl) throws IOException {
        if (object != null && object2 != null) {
            object = this.sipStack.ioHandler.sendBytes(this.messageProcessor.getIpAddress(), (InetAddress)object2, n, "TCP", (byte[])object, bl, this);
            object2 = this.mySock;
